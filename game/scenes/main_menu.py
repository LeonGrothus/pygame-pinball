...
class MainMenu(BaseDisplay):
    ...
    def awake(self) -> None:
        self.play_button = Button(Vector2(1, .3), "Play", Color(255, 255, 255), self.font, .5, self.button, self.screen)
        self.options_button = Button(Vector2(1, .45), "Options", Color(255, 255, 255), self.font, .5, self.button, self.screen)
        self.quit_button = Button(Vector2(1, .60), "Quit", Color(255, 255, 255), self.font, .5, self.button, self.screen)
        return super().awake()
